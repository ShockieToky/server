 ...
 */
final class Version20260318104249 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dungeon_reward ADD drop_chance INT DEFAULT 100 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dungeon_reward DROP drop_chance');
